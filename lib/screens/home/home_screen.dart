...
class HomeScreen extends StatefulWidget {
  ...
  @override
  State State<HomeScreen> createState() => _HomeScreenState();
}

class _HomeScreenState extends State State<HomeScreen> {
  int _currentIndex = 0;

  final List List<Widget> _screens = [
  ...
  Widget? _buildFloatingActionButton() {
    ...
    return FloatingActionButton(
      ...
      child: Icon(icon, color: AppTheme.backgroundColor),
    );
  }
